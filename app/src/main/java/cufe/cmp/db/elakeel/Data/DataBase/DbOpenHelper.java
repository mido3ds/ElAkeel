...
public class DbOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String[] creates = {
                ...
                ChefCooksMeals.SQL_CREATE_TABLE,
                ...
                OrderContainsMeals.SQL_CREATE_TABLE,
                Orders.SQL_CREATE_TABLE,
                PromoCode.SQL_CREATE_TABLE,
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        String[] drops = {
                ...
                Bills.TABLE_NAME,
                Branches.TABLE_NAME,
                ChefCooksMeals.TABLE_NAME,
                Chefs.TABLE_NAME,
                Customers.TABLE_NAME,
                Deliveries.TABLE_NAME,
                DeliveryMen.TABLE_NAME,
                Meals.TABLE_NAME,
                OrderContainsMeals.TABLE_NAME,
                Orders.TABLE_NAME,
                PromoCode.TABLE_NAME,
